  ...
  return (
    <section>
      <Switch>
        ...
        <Route path="/login" component={!token && Login} exact/>
        ...
        <Route path="/user/reset/:token" component={token ? NotFound : ResetPassword} exact/>
        <Route path="/forgot-password" component={token ? NotFound : ForgotPassword} exact/>
